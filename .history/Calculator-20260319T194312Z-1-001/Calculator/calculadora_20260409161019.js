...
while(continuar){
    ...
    switch(ope){
        ...
        case 4:
            ...
            break;
        case 5:
            num = parseFloat(prompt("Digite um número base: ")), num1 = parseFloat(prompt("Digite outro numero: "));
            alert(num );
            break;
        case 6:
            num = parseFloat(prompt("Digite um número base: ")), num1 = parseFloat(prompt("Digite o expoente: "));
